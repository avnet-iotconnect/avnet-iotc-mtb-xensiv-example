...
with the Avnet IoTConnect Platform on Microsoft Azure, leveraging the Optiga secure element.
...
guide and select the IoTConnect - Azure version:  
* [IoTConnect - AWS version](https://subscription.iotconnect.io/subscribe?cloud=azure)  
...
* Enter the **Platform** for which you subscribed ("az") and press `Enter`
